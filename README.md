...
## The recommended way:
* Run main.py and wait for your files to convert.
...
<br>
# Copyright
No files included are of copyrighted works.
<br>
All files included are products of my work and help of the internet.
<br>
